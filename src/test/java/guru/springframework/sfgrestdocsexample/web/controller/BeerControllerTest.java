...
@AutoConfigureRestDocs(uriScheme = "https", uriHost = "dev.kenneth.test", uriPort = 80)
    ...
    void getBeerById() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
                ...
                .andDo(document("v1/beer-get", pathParameters(
                        ...
                        responseFields(fieldWithPath("id").description("Id of the Beer"),
                                fieldWithPath("version").description("Id of the Beer"),
